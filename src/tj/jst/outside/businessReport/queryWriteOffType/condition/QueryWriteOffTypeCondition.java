package com.tj.jst.outside.businessReport.queryWriteOffType.condition;
 ...
 *
 */
public class QueryWriteOffTypeCondition extends Condition {
	...
	public String getInitialSql() {
		//设置排序
		this.setOrderByItem(" WRITEOFFAPPDATE desc ");
		//查询当前可用单位；
