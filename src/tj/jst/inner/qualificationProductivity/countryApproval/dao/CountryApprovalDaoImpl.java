...
//			basePstmt.setDate(28, UtilDate.getStringChangeDate());//证书有效截止日期
			basePstmt.setString(27, "1");//0：老数据 1：新数据
			basePstmt.setString(28, "01");//数据来源系统
			basePstmt.setInt(29, 1);//证书状态
			basePstmt.setString(30, newQualification.getCorpId());
			basePstmt.setString(31, newQualification.getNewQualId());
			basePstmt.setString(32, "0");
