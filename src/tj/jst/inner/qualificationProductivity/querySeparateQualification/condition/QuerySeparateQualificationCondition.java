package com.tj.jst.inner.qualificationProductivity.querySeparateQualification.condition;

import com.tj.jst.base.page.Condition;

public class QuerySeparateQualificationCondition extends Condition {
	...
	public QuerySeparateQualificationCondition() {
	...
	public String getInitialSql() {
		...
		StringBuffer sb = new StringBuffer(" where addTypeNum = '006' ");
