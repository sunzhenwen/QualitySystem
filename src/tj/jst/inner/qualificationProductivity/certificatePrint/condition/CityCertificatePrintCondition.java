 ...
 *
 */
public class CityCertificatePrintCondition extends Condition {
	...
	public CityCertificatePrintCondition()
	{
		
	}
	
	public CityCertificatePrintCondition(String deptId)
	{
		this.deptId = deptId;
	}
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb = new StringBuffer(" where rtrim(SPARE1)='"+deptId+"' and cretgrade=3 ");
...
//		}
	...
	public String getCountSql() {
		StringBuffer sb = new StringBuffer(" select distinct CorpCode,CorpName,LicenseNum,RegPrin,CertId,LegalMan,EconmicName,UpdateType from v_TBCORPCERTINFO where rtrim(SPARE1)='"+deptId+"' and cretgrade=3 ");
