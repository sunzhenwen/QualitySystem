 ...
 *
 */
public class ProvinceApprovalCondition extends Condition {
...
//	
//	public ProvinceApprovalCondition()
//	{
//		
//	}
//	
//	public ProvinceApprovalCondition(String deptId)
//	{
//		this.deptId = deptId;
//	}
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where rtrim(APPROVALDEPT)='"+deptId+"' and rtrim(cretGrade)=2 ");
		...
		System.out.println("sql省资质审批 = "+ sql);
		return sql;
	}
	...
	public String getCountSql() {
		...
		System.out.println("sqlCount省资质审批 = " + sqlCount);
		return sqlCount;
	}
