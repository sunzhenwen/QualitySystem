package com.tj.jst.inner.qualificationProductivity.queryAllApplication.action;
...
import com.tj.jst.inner.qualificationProductivity.queryAllApplication.condition.QueryAllApplicationCondition;
import com.tj.jst.inner.qualificationProductivity.queryAllApplication.service.IQueryAllApplicationService;
import com.tj.jst.inner.qualificationProductivity.queryAllApplication.service.QueryAllApplicationServiceImpl;
 ...
 *
 */
public class QueryAllApplicationAction extends BaseAction {
	...
	private QueryAllApplicationCondition condition = new QueryAllApplicationCondition();

	public void setCondition(QueryAllApplicationCondition condition) {
		this.condition = condition;
	}

	public QueryAllApplicationCondition getCondition() {
		QueryAllApplicationCondition sessionCondition = (QueryAllApplicationCondition) get(getActionName());
	...
	public String queryPage() {
		IQueryAllApplicationService allService = new QueryAllApplicationServiceImpl();
		// 分页查询
