package com.tj.jst.outside.businessReport.separateQualification.model;
 ...
 *
 */
public class SeparateQualification {
	...
	//主键
		...
		private String preCorpCode ; //被分立公司组织机构代码证号
		private String preCorpName ; //被分立公司名称
