 ...
 *
 */
public class QualityChangeQueryCondition extends Condition{
...
//	private String CretLevel;
	...
	public QualityChangeQueryCondition(String checkType,String departmentID){
...
//		}
	...
	public String getInitialSql() {
		...
		// 查询当前可用单位；
		StringBuffer sb = new StringBuffer(" where state in('3','6','9','4','7','10') ");
		System.out.println("SQL_STATE:"+SQL_STATE);
		if(SQL_STATE.equals("1"))
		{			
			sb.append(" and instr(levelset,',1,')>0 "); 			
		}
		if(SQL_STATE.equals("2"))
		{
			sb.append(" and instr(levelset,',2,')>0 ");
		}		
		if(SQL_STATE.equals("3"))
		{
			sb.append(" and instr(levelset,',3,')>0 ");
			sb.append(" and spare1='" + departmentID + "' ");
			//sb.append(" or change_spare1='" + departmentID + "' ");
		}
		//既有国家又有省级审批权
		if(SQL_STATE.equals("4")){
			sb.append(" and instr(levelset,',1,')>0 "); 
			sb.append(" or instr(levelset,',2,')>0  ");
		}
