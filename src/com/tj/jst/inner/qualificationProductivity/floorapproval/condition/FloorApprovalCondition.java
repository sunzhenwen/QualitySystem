 ...
 *
 */
public class FloorApprovalCondition extends Condition {
	...
	public String getInitialSql() {
		...
		// 查询当前可用单位；
		StringBuffer sb = new StringBuffer(" where QUALIFTYPE='a' and ( addtypenum != '007' or addtypenum != '006'  ) ");
