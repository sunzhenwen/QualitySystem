...
<script type="text/javascript">
	...
	{
		document.form1.action="<%=basepath %>/corpInfoAction_addCorpPage.action";
		document.form1.submit();
	}
			...
			<td>
			  <fieldset>
					...
					<p style="margin-bottom: 10px; text-align: right;">
						...
						<a href="#"><span class="lbchx" onclick="createCorpInfo()">添加</span></a> 
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <s:iterator status="i" value="currentPage.data" > 
                          <tr>
                            ...
                            <td align='center'><a href="corpInfoAction_modifyCorpPage.action?corpId=<s:property value="corpId"/>"><span class="lbmingx">修改</span></a></td>
                         </tr>
		</s:iterator>
       </table>
  </form>
