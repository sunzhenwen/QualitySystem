...
<input type="hidden" id="message" value="<s:property value="message" />" />
		<div class="qy_main" style="width: 100%; background: #FFF; border: 0;">
			...
			<h2 class="f16 fb" style="background: #80aced;">企业信息修改</h2>
              ...
              <tr>
                	<td>企业名称：</td>
                	<td><input type="text"  maxlength='50'   value="<s:property value="corpInfo.corpName"/>" disabled="disabled" class="required" /><strong><font color="#FF0000">*</font></strong>
                	<input type="hidden" name="corpInfo.corpName" value="<s:property value="corpInfo.corpName"/>" class="required" />
                	<input type="hidden" name="corpInfo.corpId" value="<s:property value="corpInfo.corpId"/>"/>
                	
                	</td>
                	<td>组织机构代码或统一社会信用代码：</td>
               		<td><input type="text"  maxlength='18'   disabled="disabled" value="<s:property value="corpInfo.corpCode"/>"  class="required" /><strong><font color="#FF0000">*</font></strong>
               		<input type="hidden" name="corpInfo.corpCode" value="<s:property value="corpInfo.corpCode"/>"  class="required" />
               		</td>
                ...
                <tr>
                    <td>工商营业执照注册号：</td>
                    <td><input type="text"  maxlength='18'  disabled="disabled" value="<s:property value="corpInfo.licenseNum"/>" class="required" /><strong><font color="#FF0000">*</font></strong>
                    <input type="hidden" name="corpInfo.licenseNum" value="<s:property value="corpInfo.licenseNum"/>" class="required" />
                    </td>
                
                	<td>企业营业地址：</td>
                    <td><input type="text" disabled="disabled" value="<s:property value="corpInfo.address"/>" class="required" /><strong><font color="#FF0000">*</font></strong>
                    	<input type="hidden" name="corpInfo.address" value="<s:property value="corpInfo.address"/>"  class="required" />
                    </td>
                </tr>
                ...
                <tr>
                    <td>法定代表人姓名：</td>
                    <td><input type="text" disabled="disabled" class="required"  value="<s:property value="corpInfo.legalMan"/>" /><strong><font color="#FF0000">*</font></strong>
                    <input type="hidden" name="corpInfo.legalMan" class="required"  value="<s:property value="corpInfo.legalMan"/>" />
                    </td>
                ...
                <tr>
                    ...
                    <td><input type="text"  maxlength='50'  name="corpInfo.legaManProtitle" value="<s:property value="corpInfo.legaManProtitle"/>" class="required" /><strong><font color="#FF0000">*</font></strong></td>
                     ...
                     <td>企业登记注册类型：</td>
                    <td>
	                    <select id="lstTest" onfocus="this.defaultIndex=this.selectedIndex;" onchange="this.selectedIndex=this.defaultIndex;" name="corpInfo.economicNum" class="required" >
	                    <option value="">请选择</option>
                ...
                <tr>
                    <td>注册资本（万元）：</td>
                    <td><input type="text" disabled="disabled" onkeyup="if(isNaN(value))execCommand('undo')"  onafterpaste="if(isNaN(value))execCommand('undo')" value="<s:property value="corpInfo.regPrin"/>"  class="{required:true,number:true}" /><strong><font color="#FF0000">*</font></strong>
                    <input type="hidden" name="corpInfo.regPrin" value="<s:property value="corpInfo.regPrin"/>"  class="{required:true,number:true}" />
                    </td>
                ...
                <tr>
                 ...
                 <tr>
                 	...
                 	<td>备注：</td>
                		<td >
                			<textarea name="corpInfo.description" id="textarea" value="<s:property value="corpInfo.description"/>" style="height:40px" cols="20" rows="5" ><s:property value="corpInfo.description"/><s:property value="corp.description" /></textarea>&nbsp;&nbsp;
                		</td>
                 ...
                 <tr>
                 	...
                 	<td>机械设备：</td>
                		<td >
                			<textarea name="corpInfo.machinery" id="textarea" value="<s:property value="corpInfo.machinery"/>" style="height:40px" cols="20" rows="5" ><s:property value="corpInfo.machinery"/><s:property value="corp.machinery" /></textarea>&nbsp;&nbsp;
                		</td>
