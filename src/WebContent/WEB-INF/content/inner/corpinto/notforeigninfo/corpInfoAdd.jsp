...
<script type="text/javascript">
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/corpInfoAction_queryCorpInfo.action";
...
<input type="hidden" id="message" value="<s:property value="message" />" />
	<div class="qy_wrapp">
		...
		<h2 class="f16 fb" style="background: #80aced;">公司信息添加</h2>
         <form id="form1" name="form1" method="post" action="<%=basepath %>/corpInfoAction_addCorp.action">
           <table class="qy_mtable p_left60" cellpadding="0" cellspacing="0">
               
                <tr>
                	<td>企业名称：</td>
                	<td>
                	<input type="text"  maxlength='200'  name="corpInfo.corpName" value="<s:property value="corpInfo.corpName"/>" class="required" /><strong><font color="#FF0000">*</font></strong>
                ...
                <tr>
                    ...
                    <s:iterator value="principalUnit">
                		...
                		<td>成立日期：</td><td><input id="time1" type="text" name="corpInfo.corpBirthDate" value="<s:property value="corpInfo.corpBirthDate"/>" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true,isShowClear:true,readOnly:true})" class="required" /><strong><font color="#FF0000">*</font></strong></td>
                ...
                <tr>
                 ...
                 <tr>
                 	<td>净资产(万元)：</td>
                 		<td>
                 			<input type="text"  maxlength='15' onkeyup="if(isNaN(value))execCommand('undo')"  onafterpaste="if(isNaN(value))execCommand('undo')" name="corpInfo.assets" class="require" value="<s:property value="corpInfo.assets"/>"/><strong><font color="#FF0000">*</font></strong>
                 		</td>
                 		<td>机械设备：</td>
                		<td >
