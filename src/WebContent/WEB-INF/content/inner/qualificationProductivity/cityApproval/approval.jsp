...
<script type="text/javascript">
	...
	function applythrough()
	{
		...
		if(nm.value != "")
		{
			if(confirm("请确认是否通过"))
			{
				document.form1.action="<%=basepath %>/cityApprovalAction_applythrough.action";
	...
	function applyBack()
	{
		...
		if(nmv.value != "")
		{
			if(confirm("请确认是否不通过"))
			{
				document.form1.action="<%=basepath %>/cityApprovalAction_applyBack.action";
				document.form1.submit();
			}
			else
			{
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/cityApprovalAction_goBack.action";
		document.form1.submit();
	}
...
<body>
	<div class="qy_wrapp">
        ...
        <div class="sp_main" >
         ...
         <h2 class="f16 fb" style="background:#80aced;">地市资质审批</h2>
         <form style="margin:50px;" id="form1" name="form1" method="post" action="">
            <table class="sp_mtable" style="border-collapse:collapse;" cellpadding="0" cellspacing="0">
                ...
                <tr>
                	...
                	<input type="hidden" name="newQualification.cityName" value="<s:property value="newQualification.cityName"/>" />
                ...
                <tr style="height:60px; border:0">
					...
					<td>企业拥有资质：</td>
                	<td>
                	<a href="#" onclick="getCertification('<s:property value="newQualification.corpId"/>')">详细查看</a>
                	</td>
                </tr>
                <tr style="height:60px; border:0">
                    <td>审批建议：</td>
