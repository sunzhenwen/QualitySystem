...
function querySpecialtyType(){
	...
	function query()
	{
		document.form1.action="<%=basepath %>/cityApprovalAction_queryPage.action";
	...
	function batchApplythrough(){   
		...
		if(confirm("您确定要审批选中的记录吗？")==true){
			document.form1.action="<%=basepath %>/cityApprovalAction_batchApplythrough.action";
			document.form1.submit();
		}
	}	
</script>
...
<table width="100%"  border="0" cellpadding="0" height="15%">
     <tr>
	    <td >	
	      <fieldset>
		  <legend  class="chaxuntj" >地市资质审批</legend>	
...
<table width = "100%" border  = "0"  cellpadding = "0"  cellspacing="0"   onmouseover="changeto()"  onmouseout="changeback()" >
	...
	<tr>
		...
		<td align='center'> <a href="cityApprovalAction_approvalPage.action?newQualId=<s:property value="newQualId"/>">审批</a> </td>
