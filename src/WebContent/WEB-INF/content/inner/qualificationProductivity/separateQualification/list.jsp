...
function querySpecialtyType(){
	...
	function query()
	{
		document.form1.action="<%=basepath%>/floorSeparateQualificationAction_queryPage.action";
	...
	function batchApplythrough(){   
		...
		if(confirm("您确定要审批选中的记录吗？(只能批量通过！！)")==true){
			document.form1.action="<%=basepath%>/floorSeparateQualificationAction_batchApplythrough.action";
			document.form1.submit();
		}
	}
</script>
		...
		<form id="form1" name="form1" method="post" action="">
			<table width="100%" border="0" cellpadding="0" height="15%">
				<tr>
					<td>
						<fieldset>
							<legend class="chaxuntj">大厅换证受理</legend>
				...
				<s:iterator status="i" value="currentPage.data">
					<tr>
						...
						<s:if test="checkNum != 1">
							<td align='center'><a
								href="floorSeparateQualificationAction_queryInfo.action?id=<s:property value="newQualId"/>">查看</a>
							</td>
						</s:if>
					</tr>
				</s:iterator>
