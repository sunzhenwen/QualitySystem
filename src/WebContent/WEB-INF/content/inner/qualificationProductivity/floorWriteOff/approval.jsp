...
<script type="text/javascript">
	...
	function applythrough()
	{
		...
		if(nm.value != "")
		{
			document.form1.action="<%=basepath %>/writeOffAction_floorApplyThrough.action";
	...
	function applyBack()
	{
		...
		if(nmv.value != "")
		{
			document.form1.action="<%=basepath %>/writeOffAction_floorApplyBack.action";
			document.form1.submit();
		}else
		{
			alert("请输入审批意见!");	
...
<body>
	<div class="qy_wrapp">
        ...
        <div class="sp_main" >
         ...
         <h2 class="f16 fb" style="background:#80aced;">资质注销申请(大厅审批)</h2>
