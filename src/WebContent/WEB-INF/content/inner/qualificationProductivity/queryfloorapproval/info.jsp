...
<body>
	<div class="qy_wrapp">
		...
		<div class="sp_main">
			...
			<h2 class="f16 fb" style="background: #80aced;">大厅资质受理成功历史查询</h2>
			<form style="margin: 50px;" id="form1" name="form1" method="post"
				...
				<table class="sp_mtable" style="border-collapse: collapse;"
					...
					<div style="text-align: right;">
						<input type="text" size="20" id="mes1"
							value="<s:property value="floor.mes1"/>" />许受字〔<input 
							type="text" size="10" value="<s:property value="floor.mes2"/>" id="mes2" />〕第<input
							 type="text" size="10" id="mes3"
							value="<s:property value="floor.mes3"/>" />号
					</div>
					<div>
						<input type="text" size="25" id="mes4"
							value="<s:property value="floor.mes4"/>" />：
					</div>
					<div style="text-indent: 2em;">
						你单位于<input type="text" size="10" id="mes5"
							value="<s:property value="floor.mes5"/>" />年<input  id="mes6"
							type="text" size="10" value="<s:property value="floor.mes6"/>" />月<input
							 type="text" size="10" id="mes7"
							value="<s:property value="floor.mes7"/>" />日提出的<input type="text"
							size="22" value="<s:property value="floor.mes8"/>" id="mes8"/>
						行政许可申请收愁。经审查，符合法定受理条件，本机关决定于<input type="text" size="10"
							value="<s:property value="floor.mes9"/>" id="mes9"/>年<input 
							type="text" size="10" value="<s:property value="floor.mes10"/>" id="mes10"/>月<input
							 type="text" size="10"
							value="<s:property value="floor.mes11"/>" id="mes11"/>日受理。
					</div>

					<div style="text-align: right; width: 80%; margin-top: 100px;">（行政机关许可专用印章）</div>
					<div style="text-align: right; width: 80%;">
						<input type="text" size="10"
							value="<s:property value="floor.mes12"/>" id="mes12"/>年<input 
							type="text" size="10" value="<s:property value="floor.mes13"/>" id="mes13"/>月<input
							 type="text" size="10"
							value="<s:property value="floor.mes14"/>" id="mes14"/>日
					</div>
					<div></div>
					<div></div>
	...
	<script language="javascript" type="text/javascript">
		...
		function CreatePrintPageA() {
			...
			LODOP.ADD_PRINT_TEXT(229, 336, 406, 34, document
			...
			//LODOP.ADD_PRINT_TEXT(368, 85, 306, 30, document.getElementById("mes4").value+ "：");
			//LODOP.SET_PRINT_STYLEA(0, "FontSize", 16);
			//LODOP.SET_PRINT_STYLEA(0, "FontName", "仿宋");
			
			LODOP.ADD_PRINT_TEXT(357, 85, 619, 280, document.getElementById("mes4").value+"：\n"+"    你单位于"
					+ document.getElementById("mes5").value + "年"
					+ document.getElementById("mes6").value + "月"
					+ document.getElementById("mes7").value + "日提出的"
					+ document.getElementById("mes8").value
					+ "行政许可申请收悉。经审查，符合法定受理条件，本机关决定自"
					+ document.getElementById("mes9").value + "年"
					+ document.getElementById("mes10").value + "月"
					+ document.getElementById("mes11").value + "日起受理。");
			LODOP.SET_PRINT_STYLEA(0, "FontSize", 16);
			LODOP.SET_PRINT_STYLEA(0, "FontName", "仿宋");
			...
			LODOP.ADD_PRINT_TEXT(728, 440, 265, 40, document
					...
					+ "年"
					+ document.getElementById("mes13").value
					+ "月"
					+ document.getElementById("mes14").value + "日");
			LODOP.SET_PRINT_STYLEA(0, "FontName", "仿宋");
			LODOP.SET_PRINT_STYLEA(0, "FontSize", 16);
			LODOP.SET_PRINT_STYLEA(0, "LetterSpacing", 5);
		};
