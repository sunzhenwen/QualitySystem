         ...
         <form style="margin:50px;" id="form1" name="form1" method="post" action="">
            <table class="sp_mtable" style="border-collapse:collapse;" cellpadding="0" cellspacing="0">
               ...
               <tr>
                ...
                <s:if test="newQualification.addTypeNum == '006'">
                 <tr>
                    <td>被分立/转移企业名称：</td>
               		<td>
               		<s:property value="newQualification.preCorpName"/>
               		<input type="hidden" name="newQualification.endDate" value="<s:property value="newQualification.endDate"/>" />
               		</td>
                    <td>组织机构代证：</td>
                    <td>
                    <s:property value="newQualification.preCorpCode"/>
                    </td>
                </tr>
                </s:if>
                <tr>
