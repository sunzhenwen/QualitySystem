...
<body>
	<div class="qy_wrapp">
        ...
        <div class="sp_main" >
         ...
         <form style="margin:50px;" id="form1" name="form1" method="post" action="<%=basepath %>/cityCertificatePrintAction_uploadCertificate.action" onsubmit="return validateForm()">
