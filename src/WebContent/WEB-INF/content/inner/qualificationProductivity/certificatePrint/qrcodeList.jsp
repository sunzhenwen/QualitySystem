...
<script type="text/javascript">
	...
	function query()
	{
		document.form1.action="<%=basepath %>/certificateHisPrintAction_queryPage.action";
		document.form1.submit();
	}
	
	function getPrint(certId)
	{
		   ...
		   if ((LODOP!=null)&&(typeof(LODOP.VERSION)!="undefined")) 
			{
				...
				var openUrl = "<%=basepath %>/certificateHisPrintAction_queryPrint.action?certId="+certId;
              ...
              <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" height="10%">
		        ...
		        <tr>
	  	        ...
	  	        <tr>
		  	        <td>日期选择：</td>
		  	        <td>
		  	        	<input type="text" name="condition.startTime" value="<s:property value="condition.startTime" />"   onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true,isShowClear:true,readOnly:true})" />
		  	        </td>
					<td>到</td>		
					<td>	
						<input type="text" name="condition.endTime"  value="<s:property value="condition.endTime" />"   onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true,isShowClear:true,readOnly:true})" />
					</td>
	  	        </tr>
...
<table width = "100%" border  = "0"  cellpadding = "0"  cellspacing="0"   onmouseover="changeto()"  onmouseout="changeback()" >
	...
	<tr>
		...
		<td align='center'> 
		<a href="#" onclick="getPrint('<s:property value="certId"/>')">打印</a> 
		</td>
