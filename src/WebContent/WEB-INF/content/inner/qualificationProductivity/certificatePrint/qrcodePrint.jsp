...
<script type="text/javascript">
	...
	function getPrintZB(certId)
	{
				
		var openUrl = "http://www.mohurd.gov.cn/docmaap/CertQRCodeQuery.aspx?CertID="+document.getElementById("certId").value+"&Type=1&ID="+document.getElementById("QRCODE").value;
		openUrl = encodeURI(openUrl);
		window.open(openUrl);  								 
				
	}
	
	function getPrintFB(certId)
	{
				
		var openUrl = "http://www.mohurd.gov.cn/docmaap/CertQRCodeQuery.aspx?CertID="+document.getElementById("certId").value+"&Type=2&ID="+document.getElementById("FBQRCODE").value;
		openUrl = encodeURI(openUrl);
		window.open(openUrl);  								 
        ...
        <div class="sp_main" >
         ...
         <form style="margin:50px;" id="form1" name="form1" method="post" action="">
            <table class="sp_mtable" style="border-collapse:collapse;" cellpadding="0" cellspacing="0">
	           ...
	           <div class="sp_bton"> 
		           <a href="#" onclick="getPrintZB()">正本链接</a> 
		           <a href="#" onclick="getPrintFB()">副本链接</a>        
	           </div>
             <div class="sp_bton">              
