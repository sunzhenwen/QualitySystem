...
<script type="text/javascript">
	...
	function applythrough()
	{
		...
		if(nm.value != "")
		{
			if(confirm("请确认是否通过"))
			{
				document.form1.action="<%=basepath %>/countryApprovalAction_applyUltimateThrough.action";
	...
	function applyBack()
	{
		...
		if(nmv.value != "")
		{
			if(confirm("请确认是否不通过"))
			{
				document.form1.action="<%=basepath %>/countryApprovalAction_applyUltimateThroughBack.action";
				document.form1.submit();
			}
			else
			{
