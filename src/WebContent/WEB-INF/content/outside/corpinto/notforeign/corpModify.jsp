...
<body onload="queryCity()">
	<form id="form1" name="form1" method="post"
		action="<%=basepath%>/corpAction_modifyCorp.action">
		<div class="qy_wrapp">
			<div class="index_top">
				...
				<table class="qy_mtable p_left60 left" cellpadding="0"
					...
					<tr>
						...
						<td><input type="text" maxlength='200'
							...
							<input type="hidden" value="<s:property value="corp.corpId" />"
							name="corp.corpId" /></td>
					</tr>
					<tr>
						<td>组织机构代码或统一社会信用代码：</td>
						<td><s:property value="corp.corpCode" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="hidden" value="<s:property value="corp.corpCode" />"
							name="corp.corpCode" class="required" /></td>
					</tr>
					<tr>
						<td>工商营业执照注册号：</td>
					...
					<tr>
						...
						<td><input type="text" maxlength='30'
							...
							name="corp.legalManIdCard" class="{required:true,digits:true}" /><strong><font
								color="#FF0000">*</font></strong></td>
					</tr>
					<tr>
						<td>法定代表职务：</td>
					...
					<tr>
						...
						<td><input type="text" maxlength='50'
							...
							name="corp.legaManProtitle" class="required" /><strong><font
								color="#FF0000">*</font></strong></td>
					</tr>
					<tr>
						<td>机械设备：</td>
					...
					<table class="qy_mtable left" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td><input type="text" maxlength='15'
								value="<s:property value="corp.regPrin" />"  onkeyup="if(isNaN(value))execCommand('undo')"  onafterpaste="if(isNaN(value))execCommand('undo')" name="corp.regPrin"
						...
						<tr>
							<td>实收资本（万元）：</td>
							<td><input type="text" maxlength='15'
								value="<s:property value="corp.factRegPrin" />"
								name="corp.factRegPrin"  onkeyup="if(isNaN(value))execCommand('undo')"  onafterpaste="if(isNaN(value))execCommand('undo')" class="{required:true,number:true}" /><strong><font
									color="#FF0000">*</font></strong></td>
						</tr>
						<tr>
							<td>净资产(万元)：</td>
							<td><input type="text" maxlength='15'
								value="<s:property value="corp.assets" />"  onkeyup="if(isNaN(value))execCommand('undo')"  onafterpaste="if(isNaN(value))execCommand('undo')" name="corp.assets"
								class="{required:true,number:true}" /><strong><font
									color="#FF0000">*</font></strong></td>
						</tr>
						<tr>
