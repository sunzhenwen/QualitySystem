...
<script type="text/javascript">
	...
	{
		document.form1.action="<%=basepath %>/qualityChangeAction_updateQuality.action?state="+state;
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/qualityChangePageAction_showQualityChangeInner.action";
		document.form1.submit();
	}
</script>
</head>
	...
	<div class="qy_wrapp">
        ...
        <div class="sp_main" >
         ...
         <form style="margin:50px;" id="form1" name="form1" method="post" action="">
            <table class="sp_mtable" style="border-collapse:collapse;" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td style="text-align:left; padding-left:6px;">
						...
						<input type="hidden" name="qualityChangeId" value="${qualityChange.QUALITY_CHANGE_ID}" />
					</td>
            ...
            <div class="sp_bton"> 
        		<a href="#"><span class="sp_first" onclick="apply(1)">申请通过</span></a>
        	    <a href="#"><span class="sp_second" onclick="apply(2)">退回重填</span></a>
