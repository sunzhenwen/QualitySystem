...
<script type="text/javascript">
	...
	function submitCertifiedService()
	{
		if(check()==true){
			var message = document.getElementById("typeNum").value;
				document.form1.action="<%=basepath %>/newQualificationAction_submitCertifiedService.action?typeNum="+message;
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/newQualificationAction_newApplication.action";
		document.form1.submit();
	}
