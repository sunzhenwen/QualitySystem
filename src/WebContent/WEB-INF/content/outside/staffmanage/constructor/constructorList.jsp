	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">注册建造师人员列表<img src="<%=basepath %>/img/ry_lie.png" /></p>
                	...
                	<tbody>   
                         <tr>
                          ...
                          <tr>
                            ...
                            <td><a href="constructorAction_detailed.action?idCard=<s:property value="idCard"/>&type=<s:property value="regTradeTypeNum"/>"><span>详细</span></a></td>
